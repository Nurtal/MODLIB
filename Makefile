...
simulator: main.o cell.o leucocyte.o lymphocyte.o lymphocyteT.o membrane.o nucleus.o cytoplasm.o 
	$(CXX) -o simulator main.o cell.o leucocyte.o lymphocyte.o lymphocyteT.o membrane.o nucleus.o cytoplasm.o $(LDFAGS)
...
membrane.o: cell_components/Membrane.cpp
